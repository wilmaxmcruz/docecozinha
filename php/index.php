		...
		<ul class="clear">
			...
			<li>
				<a href="javascript:changePage('lista', 'massas');">
					...
					<img itemprop="image" src="images/menu/massas.jpg" alt="massas" title="massas">
				</a>
			</li>
		</ul>
		<ul class="clear">
			...
			<li>
				<a href="javascript:changePage('lista', 'sopas');">
					...
					<img itemprop="image" src="images/menu/sopas.jpg" alt="sopas" title="sopas">
				</a>
			</li>
		</ul>			
	</div>
	<div class="recomendacao clear"  itemscope itemtype="http://schema.org/Recipe">
		<h2>
